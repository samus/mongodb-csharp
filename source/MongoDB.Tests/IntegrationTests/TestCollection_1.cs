...
namespace MongoDB.IntegrationTests
{
    ...
    public class TestCollection_1 : MongoTestBase
    {
        ...
        public void TestArrayInsert(){
            var inserts = TestsDatabase.GetCollection<InsertsEntity>("inserts");
        ...
        public void TestCanInsertNullPropertys(){
            var inserts = TestsDatabase.GetCollection<CharReadsEntity>("inserts");
        ...
        public void TestCount(){
            var counts = TestsDatabase.GetCollection<CountsEntity>("counts");
            var top = 100;
            for(var i = 0; i < top; i++)
        ...
        public void TestCountInvalidCollection(){
            var counts = TestsDatabase.GetCollection<CountsEntity>("counts_wtf");
            Assert.AreEqual(0, counts.Count());
        }

        [Test]
        public void TestCountWithSpec(){
            var counts = TestsDatabase.GetCollection<CountsEntity>("counts_spec");
        ...
        public void TestDelete(){
            var deletes = TestsDatabase.GetCollection<DeletesEntity>("deletes");
        ...
        public void TestFindAttributeLimit(){
            ...
            var fields = new {x = 1};
            var c = TestsDatabase.GetCollection<FindsEntity>("finds").Find(query, -1, 0, fields);
        ...
        public void TestFindGTRange(){
            ...
            var c = TestsDatabase.GetCollection<FindsEntity>("finds").Find(query);
            foreach(var result in c.Documents)
            {
                Assert.IsNotNull(result);
        ...
        public void TestFindNulls(){
            ...
            var numnulls = TestsDatabase.GetCollection<FindsEntity>("finds").Count(query);
        ...
        public void TestFindOne(){
            var query = new {Index = 10};
            var result = TestsDatabase.GetCollection<FindsEntity>("finds").FindOne(query);
            Assert.IsNotNull(result);
            Assert.AreEqual(4, result.x);
        ...
        public void TestFindOneObjectContainingUKPound(){
            ...
            var result = TestsDatabase.GetCollection<CharReadsEntity>("charreads").FindOne(query);
            Assert.IsNotNull(result);
        ...
        public void TestFindWhereEquivalency(){
            var col = TestsDatabase.GetCollection<FindsEntity>("finds");
        ...
        public void TestInsertOfArray(){
            ...
            var inserts = TestsDatabase.GetCollection<Album>("inserts");
        ...
        public void TestUpdateMany(){
            var updates = TestsDatabase.GetCollection<CountsEntity>("updates");
        ...
        public void CanSaveNewDocumentsWithoutId(){
            var saves = TestsDatabase.GetCollection<Document>("saves");
