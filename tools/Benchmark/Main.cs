...
#region Insert Tests
        static void RunInsertTest(string name, IMongoDatabase db, string col, Document doc, bool index, bool bulk){
        ...
        static void SetupInsert(IMongoDatabase db, string col, bool index){
            try{
        ...
        static TimeSpan TimeInsert(IMongoDatabase db, string col, Document doc, bool bulk){
        ...
        static void DoInsert(IMongoDatabase db, string col, Document doc){
        ...
        static void DoBulkInsert(IMongoDatabase db, string col, Document doc, int size){
...
#region Encode Tests
        ...
        #region Find Tests
        static void RunFindTest(string name, IMongoDatabase db, string col, Document spec, bool range){
            TimeSpan lowest = TimeSpan.MaxValue;
            for(int i = 0; i < trials; i++){
        ...
        static TimeSpan TimeFind(IMongoDatabase db, string col,Document psec, bool range){
            DateTime start = DateTime.Now;
            if(range){
        ...
        static void DoFindOne(IMongoDatabase db, string col, Document spec){
            for(int i = 0; i < perTrial; i++){
                db[col].FindOne(spec);
            }
        }

        static void DoFind(IMongoDatabase db, string col, Document spec){
            for(int i = 0; i < perTrial; i++){
